...
2. 의존성
    ...
    - 일반 의존성 : 개발하고 있는 프로젝트에서 사용하는 패키지로 꼭 비륻와 배포에 포함되어야 한다.
...
3. 패키지 설치
    ...
    4) 패키지 삭제
        ...
        $npm up -g gulp     [global install 삭제]
        $npx gulp --version
...
5.  Module
    ...
    3) npm 모듈 : npm을 통해서 node_modules 에 설치하고 사용하는 모듈
        - 원격 배포가 된 패키지를 설치(npmjs.org)
            npmjs.com의 npm registry 에 패키지 배포
        - 로컬 설치
            $npm i ../douzone-math
